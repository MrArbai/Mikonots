            ...
            <table class="table table-hover table-condensed">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <center><?php echo number_format($val); ?> Pcs</center>
                            </td>
                            <td>
                ...
                <?php } else { ?>
                    ...
                    <td colspan="4" style="font-size: 18px;"><b>
                            <div class="pull-right">Total Belanja Anda : Rp. <?php echo number_format($total); ?>,- </div>
                        </b></td>
                ...
                <div class="hero-unit" style="margin-left: 20px;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <div class="clear"> <a href="cart.php?act=add&amp;barang_id=<?php echo $data['br_id']; ?>&amp;ref=detailproduk.php?kd=<?php echo $data['br_id']; ?>" class="btn btn-lg btn-danger">Beli &raquo;</a></div>
                            </td>
                        </tr>
